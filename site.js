...
(function () {
  ...
  var SESSIONS = [
    ...
    { n: 11, group: "impl", title: "동적 메모리와 malloc",
      goal: "스택 vs 힙, malloc/free로 calloc·substr·strjoin·itoa·strdup을 만든다.",
    ...
    { n: 13, group: "impl", title: "문자열 함수 II",
      goal: "순/역방향 검색 strchr·strrchr, 부분 문자열 strnstr을 구현하고 파일 검색에 응용한다.",
      tags: ["strchr", "strrchr", "strnstr"], folder: "session_13" },
    { n: 14, group: "impl", title: "문자열 비교와 변환",
      goal: "strncmp 비교, atoi 파싱(부호·공백)을 구현하고 버전 비교기·계산기에 응용한다.",
      tags: ["strncmp", "atoi"], folder: "session_14" },
    ...
    { n: 16, group: "impl", title: "종합 프로젝트 + 코드 리뷰",
      goal: "32개 함수를 libsbs로 통합하고, 통합 Makefile과 동료 코드 리뷰로 마무리한다.",
