...
1. 9~14차시에서 만든 26개 함수를 하나의 `libsbs`로 통합한다.
...
총 **26개**. 각 차시 폴더의 `sbs_*.c`를 한 폴더로 모읍니다.
...
```bash
$ make          # 26개 컴파일 → libsbs.a
$ ar t libsbs.a # 26개 오브젝트 확인
```
